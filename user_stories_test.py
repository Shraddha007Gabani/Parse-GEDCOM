...
class TestApp(unittest.TestCase):
    ...
    def test_no_sibilings_can_marry(self):
        ...
        self.assertEqual(AreIndividualsUnique(individuals), [["I2", "John Doe", "14 OCT 1990"]])
        ...
        self.assertEqual(uniqueFamilyBySpouses(families), [["I2", "John Doe1", "jennifer Doe1", "14 OCT 1993"]])
